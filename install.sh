...
MODULE_DIR="www/modules/pdfreports/"
...
function install_module() {
	echo ""
	echo "$line"
	echo -e "\tPDFReports Module Installation"
	echo "$line"
	
	TEMP_D="/tmp/installation-pdfreports"
...
###############################################################################
#                                                                             #
#              Module : PDFReports version $VERSION                    #
#                                                                             #
###############################################################################
__EOT__
